...
kable(to_print, format = "latex" , longtable = TRUE, caption = "List of functional traits for Chapter 1 study", booktabs = T) %>% kable_styling(font_size = 8)
```
...
tab <- read.csv("~/grad/archive/quals/proposal/ch3-table.csv")
