...
fontfamily: mathpazo
fontsize: 12pt
header-includes: \usepackage{tabularx} \usepackage{float,booktabs,longtable,multirow} \usepackage{graphicx,colortbl,xcolor}\usepackage{mathptmx,fixltx2e} \usepackage[font=small,skip=0pt]{caption}
csl: ecology.csl
...
knitr::kable(to_print, caption="Species list for functional resposne curve analyses", longtable = TRUE, booktabs = T)
```
\normalsize
